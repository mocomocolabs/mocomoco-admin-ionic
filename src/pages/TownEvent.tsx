...
export const TownEvent: React.FC = () => {
  ...
  // console.log('이것은 무엇인가', format(new Date(), 'yyyy-MM-dd'))
        ...
        <IonContent>
            ...
            <div className='search-area-input'>
              <IonList lines="none">
                ...
                <IonItem>
                  ...
                  <IonDatetime displayFormat="YYYY/MM/DD" onChange={(staDt): any => $home.setStaDt(staDt)} placeholder="Select Date" min="2021-01-01" max={todayDate}></IonDatetime>
                </IonItem>
                <IonItem>
                  <IonLabel>끝날짜</IonLabel>
                  <IonDatetime displayFormat="YYYY/MM/DD" onChange={(endDt): any => $home.setEndDt(endDt)} placeholder="Select Date" min="2021-01-01" max={todayDate}></IonDatetime>
                </IonItem>
                <Input
          ...
          <div className="result-list-wrap">
            <IonList className="mb-8">
              ...
              {$home.getCurMonEventList !== undefined && $home.getCurMonEventList.map((a, index) => {
                return (
                  <IonItem key={index}>
